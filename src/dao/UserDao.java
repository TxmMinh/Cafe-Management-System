...
public class UserDao {
    public static void save(User user) {
        String query = "insert into user(name, email, mobileNumber, address, password, securityQuestion, answer, status)"
                ...
                + user.getAddress() + "','" + user.getPassword() + "','" + user.getSecurityQuestions() + "','"
    ...
    public static User getSecurityQuestion(String email) {
        ...
        try {
            ...
            while (rs.next()) {
                user = new User();
                user.setSecurityQuestions(rs.getString("securityQuestion"));
    ...
    public static void update(String email, String securityQuestion, String answer) {
        String query = "update user set securityQuestion = '" + securityQuestion + "', answer = '" 
